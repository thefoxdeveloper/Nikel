...
function getCashIn() {
  ...
  if (cashIn.length) {
    ...
    for (let index = 0; index < limit; index++) {
      ...
      <div class="col-12">
        <h3 class="fs-2">R$ ${cashIn[index].value.toLocaleString("pt-BR", {
  ...
  if (cashOut.length) {
    ...
    for (let index = 0; index < limit; index++) {
      cashOutHtml += ` <div class="row mb-4">
        <div class="col-12">
          <h3 class="fs-2">R$ ${cashOut[index].value.toLocaleString("pt-BR", {
            minimumFractionDigits: 2,
            maximumFractionDigits: 2,
          })}</h3>
          <div class="container p-0">
...
function getTotal() {
  ...
  document.getElementById("total").innerHTML = `R$ ${total.toLocaleString(
    "pt-BR",
